...
echo 'src-git https://github.com/chandelures/openwrt-clash.git' >> feeds.conf.default
echo 'src-git https://github.com/chandelures/luci-app-simple-clash.git' >> feeds.conf.default
